...
class MongoMixin:
    def __init_subclass__(cls, **kwargs):
        attr_to_check = ["mdb_obj", "klass", "mec", "pk", "uk"]
    ...
    def is_mapped(self):
        with self.mec:
            objs = self.klass.objects(unique_key=self.uk)
            return False if (objs.count()) <= 0 or self.pk is None else True
    ...
    def save(self, **kwargs):
        ...
        logger.info("{} saved".format(self.mdb_obj.unique_key))
